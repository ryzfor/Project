    ...
    <div class="container">
        ...
        <div>
            ...
            <table class="table">
                ...
                $sql = "SELECT * from socios WHERE id_socio LIKE '%$code%' ";
        ...
        <div>
            <table width="40%" height="70">
                <tr>
                    <td><label for="checkInvited">¿Es un familiar?</label></td>
        ...
        <div id="container_invited">
            <h2>Ingresar datos del Familiar</h2>
            <form action="" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" maxlength="40" class="form-control" id="paren" name="paren" required>
                </div>
                <div class="form-group">
                ...
                if (!empty($_POST)) {
                    ...
                    if (empty($name) || empty($lastname) || empty($age) || empty($documentNumber) || empty($email) || empty($paren) || empty($date) || empty($code)) {
                        ...
                        if (empty($result)) {
                            $query_insert = mysqli_query($conexion, "INSERT INTO familiares(tip_doc, num_doc, nombre, apellido, parentesco, id_socio) 
                                                                        VALUES('D01', '$documentNumber', '$name', '$lastname', '$paren', '$code')");
                            if ($query_insert) {
